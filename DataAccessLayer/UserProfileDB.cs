    ...
    public class UserProfileDB : GenericRepositoryDL<MUserProfile>, IUserProfileDB
    {
        ...
        public async Task<DTOUserProfileResponse?> GetByArmyNo(string ArmyNo, int UserId)
        {
            try
            {
                ...
                string query = "SELECT prof.ArmyNo,prof.UserId,prof.Name,prof.MobileNo,prof.DialingCode,prof.Extension,prof.Thumbprint,prof.IntOffr,prof.IsIO,prof.IsCO,ran.RankName Rank,ran.RankId,mapu.UnitMapId UnitId,munit.UnitName,users.DomainId," +
