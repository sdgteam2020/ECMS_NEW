        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Corps = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Div = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Bde = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileDatas", x => x.ProfileDataId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MapUnit", x => x.UnitId);
                    table.ForeignKey(
