...
namespace DataTransferObject.Requests
{
    public class DTOBasicDetailTempRequest : Common
    {
        ...
        [Required(ErrorMessageResourceType = typeof(ErrorMessages), ErrorMessageResourceName = "RequiredError")]
        [DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}", ApplyFormatInEditMode = true)]
        public string DOB_ { get; set; } = string.Empty;
        ...
        [Required(ErrorMessageResourceType = typeof(ErrorMessages), ErrorMessageResourceName = "RequiredError")]
        [DisplayFormat(DataFormatString = "{0:dd/MM/yyyy}", ApplyFormatInEditMode = true)]
        public string DOC_ { get; set; } = string.Empty;
        ...
        [Required]
        [Range(1, 2, ErrorMessage = "ApplyForId must be 1 or 2.")]
        public byte ApplyForId { get; set; }

        [Required]
        [Range(1,10, ErrorMessage = "ApplyForId must be 1 or 2.")]
