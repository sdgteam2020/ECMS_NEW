...
namespace Web.Controllers
{
    ...
    public class ApiController : Controller
    {
        ...
        {
            DTOApiPersDataFinalResponse res1 = new DTOApiPersDataFinalResponse();
            try
            {
                ...
                else if (FromApiJCO == true && Type == 2)
                {
                    ...
                    if (ret != null)
                    {
                        ...
                        DTOApiPersDataFinalResponse? res = await _aPIBL.GetData(retdat);
                        ...
                        if (res != null)
                        {
                            if (res.Pers_Army_No != null)
                            {
                                ...
                                if (res.Pers_House_no != null)
                                {
                                    res.Pers_House_no = apiHelpers.EncDec(res.Pers_House_no, PubKeyForDesc, false);
                                }
                                if (res.Pers_Moh_st != null)
                                {
                                    res.Pers_Moh_st = apiHelpers.EncDec(res.Pers_Moh_st, PubKeyForDesc, false);
                                }
                                if (res.Pers_Village != null)
                                {
                                    res.Pers_Village = apiHelpers.EncDec(res.Pers_Village, PubKeyForDesc, false);
                                }
                                if (res.Pers_Tehsil != null)
                                {
                                    res.Pers_Tehsil = apiHelpers.EncDec(res.Pers_Tehsil, PubKeyForDesc, false);
                                }
                                if (res.Pers_Post_office != null)
                                {
                                    res.Pers_Post_office = apiHelpers.EncDec(res.Pers_Post_office, PubKeyForDesc, false);
                                }
                                if (res.Pers_Police_stn != null)
                                {
                                    res.Pers_Police_stn = apiHelpers.EncDec(res.Pers_Police_stn, PubKeyForDesc, false);
                                }
                                if (res.Pers_Pin_code != null)
                                {
                                    res.Pers_Pin_code = apiHelpers.EncDec(res.Pers_Pin_code, PubKeyForDesc, false);
                                }
                                if (res.Pers_District != null)
                                {
                                    res.Pers_District = apiHelpers.EncDec(res.Pers_District, PubKeyForDesc, false);
                                }
                                if (res.Pers_State != null)
                                {
                                    res.Pers_State = apiHelpers.EncDec(res.Pers_State, PubKeyForDesc, false);
                                }
