...
namespace Web.Controllers
{
    ...
    public class BasicDetailController : Controller
    {
        ...
        public BasicDetailController(IConfiguration configuration, IBasicDetailBL basicDetailBL, IMapUnitBL mapUnitBL, IBasicDetailTempBL basicDetailTempBL, IService service,
           ...
           IOROMappingBL oROMappingBL, IRegimentalBL regimentalBL, IRecordOfficeBL recordOfficeBL, ICompletedICardRequestBL _completedICardRequestBL, IHttpContextAccessor httpContextAccessor)
        {
