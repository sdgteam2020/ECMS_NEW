...
$(function () {
    ...
    $('.form-control-AllowedKey').on("keypress", function (e) {
        ...
        if ((keyCode >= 65 && keyCode <= 90) || (keyCode >= 97 && keyCode <= 122) || (keyCode >= 48 && keyCode <= 57) || (keyCode == 32) || keyCode == 95 || keyCode == 47) {
            ...
            toastr.warning('Only Alphabets, Underscore, forward slash and Numbers allowed');
            return false; // Block the keypress
        }
    });
    ...
    /////////////////////////////////////////tbldatatabledata//////////////////////////
    setTimeout(function () {
        let element = document.getElementById("tbldatatabledata");
        if (element) {
                ...
                "buttons": [
                    {
                        ...
                        customize: function (doc) {
                            ...
                            // var logo = getBase64FromImageUrl('datatables.net/media/images/logo.png');
                            // The above call should work, but not when called from codepen.io
                            // So we use a online converter and paste the string in.
                            // Done on codebeautify.org/image-to-base64-converter
                            ...
                            // github.com/bpampuch/pdfmake#getting-started
    ...
    setTimeout(function () {
        var element = document.getElementById("tbldatatableForApprovalIO");
        if (element) {
...
function PrintData(div) {
    ...
    printWindow.document.write('<link href="' + HostUrl + '/DeveloperCSS/WaterMark.css" rel="stylesheet" />');
