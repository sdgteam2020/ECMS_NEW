...
//                     <table id="myTable" class="table table-striped table-hover border border-purple csv-preview-table" role="grid">
//                       <thead>
//                         <tr>
//                           ${tableHeader}
//                         </tr>
...
//                $(window).off('resize.csvPreview').on('resize.csvPreview', function () {
//                    table.columns.adjust();
//                });
//            },
//            willClose: () => {
//                $(window).off('resize.csvPreview');
